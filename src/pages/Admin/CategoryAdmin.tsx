      ...
      {activeView === "selection" && (
        <div className="space-y-6 sm:space-y-8">
          ...
          <div className="text-center">
            <h2 className="text-2xl sm:text-3xl font-bold text-white mb-2">Gestión de Categorías</h2>
            ...
            >
              <div className="flex flex-col items-center gap-3 sm:gap-4">
                ...
                <div className="text-center">
                  ...
                  <p className="text-slate-400 text-xs sm:text-sm">Consulta, edita y administra</p>
                </div>
              </div>
            </button>
            ...
            >
              <div className="flex flex-col items-center gap-3 sm:gap-4">
                ...
                <div className="text-center">
                  ...
                  <p className="text-slate-400 text-xs sm:text-sm">Añade una nueva categoría</p>
                </div>
              </div>
            </button>
        ...
        <div className="space-y-4">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-4 sm:mb-6 gap-3">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="text-lg sm:text-xl font-bold text-white">Listar Categorías</h3>
        ...
        <div className="space-y-4">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-4 sm:mb-6 gap-3">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="text-lg sm:text-xl font-bold text-white">Crear Categoría</h3>
                <p className="text-slate-300 text-xs sm:text-sm">
