        ...
        <div className="space-y-4">
          {isLoading ? (
            ...
            tableData.map((product) => (
              ...
              >
                {/* Botón de acción solo si EditDeleteComponent existe */}
                {EditDeleteComponent && (
                  <button
                ...
                <div className={EditDeleteComponent ? "pr-12" : ""}>
                  {/* Header del producto */}
                  <div className="mb-4">
                    ...
                    <div className="flex items-center gap-3 text-sm">
                      <span className="text-slate-500 font-mono">
                        ID: <span className="text-slate-400">{product.id}</span>
                      </span>
                  ...
                  {/* Precio destacado */}
                  <div className="mb-4 p-3 bg-gradient-to-br from-emerald-500/10 to-emerald-600/5 border border-emerald-500/20 rounded-xl">
